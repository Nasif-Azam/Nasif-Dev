...
class Logger:
    """Centralized logging with colored output - Windows compatible"""
    ...
    # Use ASCII-safe symbols that work on Windows PowerShell
    SYMBOLS = {
        'success': '[+]',    # Success (ASCII safe)
        'error': '[!]',      # Error (ASCII safe)
        'warning': '[*]',    # Warning (ASCII safe)
        'info': '[>]',       # Info (ASCII safe)
    }
    ...
    def success(message: str) -> None:
        """Log success message"""
        try:
            print(f"{Logger.COLORS['SUCCESS']}{Logger.SYMBOLS['success']} {message}{Logger.COLORS['END']}")
        except UnicodeEncodeError:
            print(f"{Logger.SYMBOLS['success']} {message}")
    
    @staticmethod
    def error(message: str) -> None:
        """Log error message"""
        try:
            print(f"{Logger.COLORS['ERROR']}{Logger.SYMBOLS['error']} {message}{Logger.COLORS['END']}")
        except UnicodeEncodeError:
            print(f"{Logger.SYMBOLS['error']} {message}")
    
    @staticmethod
    def warning(message: str) -> None:
        """Log warning message"""
        try:
            print(f"{Logger.COLORS['WARNING']}{Logger.SYMBOLS['warning']} {message}{Logger.COLORS['END']}")
        except UnicodeEncodeError:
            print(f"{Logger.SYMBOLS['warning']} {message}")
    
    @staticmethod
    def info(message: str) -> None:
        """Log info message"""
        try:
            print(f"{Logger.COLORS['INFO']}{Logger.SYMBOLS['info']} {message}{Logger.COLORS['END']}")
        except UnicodeEncodeError:
            print(f"{Logger.SYMBOLS['info']} {message}")
